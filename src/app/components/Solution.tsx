...
import { Search, ClipboardList, Rocket, BarChart3, Check } from 'lucide-react';
...
const solutions = [
  {
    ...
    icon: Search,
    bullets: ["Gaspillages détectés", "Opportunités manquées", "Diagnostics précis"]
  },
  {
    title: "Plan d'Action",
    description: "On dresse un plan d'actions priorisé par impact",
    icon: ClipboardList,
    bullets: ["Quick wins", "Priorités claires", "Roadmap étape par étape"]
  },
  {
    title: "Action Guidée",
    description: "On vous accompagne dans la mise en place technique",
    icon: Rocket,
    bullets: ["Support dédié", "Tutoriels vidéos", "Assistance direct"]
  },
  {
    title: "Suivi Continu",
    description: "On suit vos métriques et on optimise en continu",
    icon: BarChart3,
    bullets: ["Alertes intelligentes", "Rapports hebdo", "Insights temps réel"]
  }
];
